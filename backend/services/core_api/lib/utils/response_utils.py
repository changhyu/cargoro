...
class ResponseMeta(BaseModel):
    ...
    per_page: Optional[int] = None  # Changed from perPage to per_page
    total_items: Optional[int] = None  # Changed from totalItems to total_items
    total_pages: Optional[int] = None  # Changed from totalPages to total_pages
...
def bad_request_exception(message: str, code: str = "BAD_REQUEST") -> ApiException:
    """잘못된 요청 시 사용하는 예외"""
    return ApiException(
