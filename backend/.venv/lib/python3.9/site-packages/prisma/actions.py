...
class RepairActions(Generic[_PrismaModelT]):
    __slots__ = (
        '_client',
        '_model',
    )
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await Repair.prisma().query_raw(
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await Repair.prisma().query_first(
            'SELECT * FROM Repair WHERE vehicle_id = $1',
            'hiagajie',
        )
        ```
        """
    ...
    async def create(
        self,
        data: types.RepairCreateInput,
        include: Optional[types.RepairInclude] = None
    ) -> _PrismaModelT:
        ...
        data
            Repair record data
        include
            Specifies which relations should be loaded on the returned Repair model

        Returns
        -------
        prisma.models.Repair
            The created Repair record
        ...
        -------
        ```py
        # create a Repair record from just the required fields
        repair = await Repair.prisma().create(
            data={
                # data to create a Repair record
                'vehicle_id': 'eeejidbif',
                'repair_type': enums.RepairType.REGULAR,
                'description': 'efgbahec',
                'estimated_hours': 769084151.133459,
            },
        )
        ```
        """
    ...
    async def create_many(
        self,
        data: List[types.RepairCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> int:
        """Create multiple Repair records at once.
        ...
        -------
        ```py
        total = await Repair.prisma().create_many(
            data=[
                {
                    # data to create a Repair record
                    'vehicle_id': 'bbbghgbadh',
                    'repair_type': enums.RepairType.REGULAR,
                    'description': 'bbhcgagaic',
                    'estimated_hours': 330014611.176815,
                },
                {
                    # data to create a Repair record
                    'vehicle_id': 'hbgcihef',
                    'repair_type': enums.RepairType.REGULAR,
                    'description': 'ffhgghde',
                    'estimated_hours': 812032495.132356,
                },
            ],
            skip_duplicates=True,
        )
    ...
    async def delete(
        self,
        where: types.RepairWhereUniqueInput,
        include: Optional[types.RepairInclude] = None
    ) -> Optional[_PrismaModelT]:
        """Delete a single Repair record.

        Parameters
        ----------
        where
            Repair filter to select the record to be deleted, must be unique
        include
            Specifies which relations should be loaded on the returned Repair model
        ...
        -------
        ```py
        repair = await Repair.prisma().delete(
            where={
                'id': 'edhjgdfh',
            },
        )
    ...
    async def find_unique(
        ...
        """Find a unique Repair record.

        Parameters
        ----------
        where
            Repair filter to find the record, must be unique
        include
            Specifies which relations should be loaded on the returned Repair model
        ...
        -------
        ```py
        repair = await Repair.prisma().find_unique(
            where={
                'id': 'bdeffdadda',
            },
        )
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique Repair record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        repair = await Repair.prisma().find_unique_or_raise(
            where={
                'id': 'bjgfdihchf',
            },
        )
    ...
    async def find_many(
        ...
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.RepairWhereInput] = None,
        cursor: Optional[types.RepairWhereUniqueInput] = None,
        include: Optional[types.RepairInclude] = None,
        order: Optional[Union[types.RepairOrderByInput, List[types.RepairOrderByInput]]] = None,
        distinct: Optional[List[types.RepairScalarFieldKeys]] = None,
    ) -> List[_PrismaModelT]:
        """Find multiple Repair records.
        ...
        ----------
        take
            Limit the maximum number of Repair records returned
        skip
            Ignore the first N results
        where
            Repair filter to select records
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Repair model
        order
            Order the returned Repair records by any field
        distinct
            Filter Repair records by either a single distinct field or distinct combinations of fields

        Returns
        -------
        List[prisma.models.Repair]
            The list of all Repair records that could be found
        ...
        -------
        ```py
        # find the first 10 Repair records
        repairs = await Repair.prisma().find_many(take=10)

        # find the first 5 Repair records ordered by the repair_type field
        repairs = await Repair.prisma().find_many(
            take=5,
            order={
                'repair_type': 'desc',
            },
    ...
    async def find_first(
        ...
        skip
            Ignore the first N records
        where
            Repair filter to select the record
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Repair model
        ...
        -------
        prisma.models.Repair
            The first Repair record found, matching the given arguments
        None
            No record could be found
        ...
        -------
        ```py
        # find the second Repair record ordered by the description field
        repair = await Repair.prisma().find_first(
            skip=1,
            order={
                'description': 'desc',
            },
    ...
    async def find_first_or_raise(
        ...
        """Find a single Repair record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second Repair record ordered by the estimated_hours field
        repair = await Repair.prisma().find_first_or_raise(
            skip=1,
            order={
    ...
    async def update(
        self,
        data: types.RepairUpdateInput,
        where: types.RepairWhereUniqueInput,
        include: Optional[types.RepairInclude] = None
    ) -> Optional[_PrismaModelT]:
        """Update a single Repair record.

        Parameters
        ----------
        data
            Repair record data specifying what to update
        where
            Repair filter to select the unique record to create / update
        include
            Specifies which relations should be loaded on the returned Repair model
        ...
        -------
        ```py
        repair = await Repair.prisma().update(
            where={
                'id': 'iaeihdeei',
            },
            data={
                # data to update the Repair record to
            },
        )
        ```
        """
    ...
    async def upsert(
        ...
        -------
        prisma.models.Repair
            The created or updated Repair record
        ...
        -------
        ```py
        repair = await Repair.prisma().upsert(
            where={
                'id': 'bfggejgfbd',
            },
            data={
    ...
    async def update_many(
        self,
        data: types.RepairUpdateManyMutationInput,
        where: types.RepairWhereInput,
    ) -> int:
        """Update multiple Repair records

        Parameters
        ----------
        data
            Repair data to update the selected Repair records to
        where
            Filter to select the Repair records to update

        Returns
        -------
        int
            The total number of Repair records that were updated
        ...
        total = await Repair.prisma().update_many(
            data={
                'technician_id': 'ifaaaedja'
            },
            where={}
        )
        ```
    ...
    async def count(
        ...
        """Count the number of Repair records present in the database

        Parameters
        ----------
        select
            Select the Repair fields to be counted
        take
            Limit the maximum result
        skip
            Ignore the first N records
        where
            Repair filter to find records
        cursor
            Specifies the position in the list to start counting results from, (typically an ID field)
        order
            This parameter is deprecated and will be removed in a future release
        ...
        prisma.types.RepairCountAggregateOutput
            Data returned when `select` is used, the fields present in this dictionary will
            match the fields passed in the `select` argument
        ...
        ```py
        # total: int
        total = await Repair.prisma().count()

        # results: prisma.types.RepairCountAggregateOutput
        results = await Repair.prisma().count(
            select={
                '_all': True,
                'reservation_id': True,
            },
    ...
    async def count(
        self,
        select: types.RepairCountAggregateInput,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.RepairWhereInput] = None,
        cursor: Optional[types.RepairWhereUniqueInput] = None,
    ) -> types.RepairCountAggregateOutput:
        ...

    async def count(
        self,
        select: Optional[types.RepairCountAggregateInput] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.RepairWhereInput] = None,
        cursor: Optional[types.RepairWhereUniqueInput] = None,
    ) -> Union[int, types.RepairCountAggregateOutput]:
        """Count the number of Repair records present in the database
        ...
        if select is None:
            ...
            return cast(types.RepairCountAggregateOutput, resp['data']['result']['_count'])

    async def delete_many(
        self,
        where: Optional[types.RepairWhereInput] = None
    ) -> int:
        """Delete multiple Repair records.

        Parameters
        ----------
        where
            Optional Repair filter to find the records to be deleted

        Returns
        -------
        int
            The total number of Repair records that were deleted
        ...
        total = await Repair.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            method='delete_many',
    ...
    async def group_by(
        self,
        by: List['types.RepairScalarFieldKeys'],
        *,
        where: Optional['types.RepairWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        avg: Optional['types.RepairAvgAggregateInput'] = None,
        sum: Optional['types.RepairSumAggregateInput'] = None,
        min: Optional['types.RepairMinAggregateInput'] = None,
        max: Optional['types.RepairMaxAggregateInput'] = None,
        having: Optional['types.RepairScalarWhereWithAggregatesInput'] = None,
        count: Optional[Union[bool, 'types.RepairCountAggregateInput']] = None,
        order: Optional[Union[Mapping['types.RepairScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.RepairScalarFieldKeys', 'types.SortOrder']]]] = None,
    ) -> List['types.RepairGroupByOutput']:
        """Group Repair records by one or more field values and perform aggregations
        each group such as finding the average.

        Parameters
        ----------
        by
            List of scalar Repair fields to group records by
        where
            Repair filter to select records
        take
            Limit the maximum number of Repair records returned
        ...
        Returns
        -------
        List[prisma.types.RepairGroupByOutput]
            A list of dictionaries representing the Repair record,
            this will also have additional fields present if aggregation arguments
            are used (see the above parameters)
        ...
        -------
        ```py
        # group Repair records by completion_time values
        # and count how many records are in each group
        results = await Repair.prisma().group_by(
            ['completion_time'],
            count=True,
        )
        ```
...
class StatusHistoryActions(Generic[_PrismaModelT]):
    __slots__ = (
        '_client',
        '_model',
    )
    ...
    async def query_raw(
        ...
        *args
        ...
        Returns
        -------
        List[prisma.models.StatusHistory]
            The records returned by the SQL query
        ...
        -------
        ```py
        users = await StatusHistory.prisma().query_raw(
            'SELECT * FROM StatusHistory WHERE id = $1',
            'cbajdjjabf',
        )
        ```
        """
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await StatusHistory.prisma().query_first(
            'SELECT * FROM StatusHistory WHERE repair_id = $1',
            'bcicggedea',
        )
        ```
        """
    ...
    async def create(
        self,
        data: types.StatusHistoryCreateInput,
        include: Optional[types.StatusHistoryInclude] = None
    ) -> _PrismaModelT:
        ...
        ----------
        data
            StatusHistory record data
        include
            Specifies which relations should be loaded on the returned StatusHistory model

        Returns
        -------
        prisma.models.StatusHistory
            The created StatusHistory record
        ...
        -------
        ```py
        # create a StatusHistory record from just the required fields
        statushistory = await StatusHistory.prisma().create(
            data={
                # data to create a StatusHistory record
                'repair_id': 'cebcdadjh',
                'status': enums.RepairStatus.PENDING,
            },
        )
        ```
        """
    ...
    async def create_many(
        self,
        data: List[types.StatusHistoryCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> int:
        """Create multiple StatusHistory records at once.
        ...
        ----------
        data
            List of StatusHistory record data
        skip_duplicates
            Boolean flag for ignoring unique constraint errors
        ...
        -------
        ```py
        total = await StatusHistory.prisma().create_many(
            data=[
                {
                    # data to create a StatusHistory record
                    'repair_id': 'ehfigdgac',
    ...
    async def delete(
        self,
        where: types.StatusHistoryWhereUniqueInput,
        include: Optional[types.StatusHistoryInclude] = None
    ) -> Optional[_PrismaModelT]:
        """Delete a single StatusHistory record.

        Parameters
        ----------
        where
            StatusHistory filter to select the record to be deleted, must be unique
        include
            Specifies which relations should be loaded on the returned StatusHistory model
        ...
        -------
        prisma.models.StatusHistory
            The deleted StatusHistory record
        None
            Could not find a record to delete
        ...
        -------
        ```py
        statushistory = await StatusHistory.prisma().delete(
            where={
                'id': 'bigjhdgbjc',
            },
        )
    ...
    async def find_unique(
        ...
        """Find a unique StatusHistory record.

        Parameters
        ----------
        where
            StatusHistory filter to find the record, must be unique
        include
            Specifies which relations should be loaded on the returned StatusHistory model
        ...
        -------
        prisma.models.StatusHistory
            The found StatusHistory record
        None
            No record matching the given input could be found
        ...
        -------
        ```py
        statushistory = await StatusHistory.prisma().find_unique(
            where={
                'id': 'bfifdebhfd',
            },
        )
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique StatusHistory record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        statushistory = await StatusHistory.prisma().find_unique_or_raise(
            where={
                'id': 'cjchbjde',
            },
        )
    ...
    async def find_many(
        ...
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.StatusHistoryWhereInput] = None,
        cursor: Optional[types.StatusHistoryWhereUniqueInput] = None,
        include: Optional[types.StatusHistoryInclude] = None,
        order: Optional[Union[types.StatusHistoryOrderByInput, List[types.StatusHistoryOrderByInput]]] = None,
        distinct: Optional[List[types.StatusHistoryScalarFieldKeys]] = None,
    ) -> List[_PrismaModelT]:
        """Find multiple StatusHistory records.
        ...
        ----------
        take
            Limit the maximum number of StatusHistory records returned
        skip
            Ignore the first N results
        where
            StatusHistory filter to select records
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned StatusHistory model
        order
            Order the returned StatusHistory records by any field
        distinct
            Filter StatusHistory records by either a single distinct field or distinct combinations of fields

        Returns
        -------
        List[prisma.models.StatusHistory]
            The list of all StatusHistory records that could be found
        ...
        -------
        ```py
        # find the first 10 StatusHistory records
        statushistorys = await StatusHistory.prisma().find_many(take=10)

        # find the first 5 StatusHistory records ordered by the status field
        statushistorys = await StatusHistory.prisma().find_many(
            take=5,
            order={
                'status': 'desc',
            },
    ...
    async def find_first(
        ...
        """Find a single StatusHistory record.
        ...
        skip
            Ignore the first N records
        where
            StatusHistory filter to select the record
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned StatusHistory model
        ...
        -------
        prisma.models.StatusHistory
            The first StatusHistory record found, matching the given arguments
        None
            No record could be found
        ...
        -------
        ```py
        # find the second StatusHistory record ordered by the timestamp field
        statushistory = await StatusHistory.prisma().find_first(
            skip=1,
            order={
                'timestamp': 'desc',
            },
    ...
    async def find_first_or_raise(
        ...
        """Find a single StatusHistory record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second StatusHistory record ordered by the note field
        statushistory = await StatusHistory.prisma().find_first_or_raise(
            skip=1,
            order={
                'note': 'desc',
            },
    ...
    async def update(
        self,
        data: types.StatusHistoryUpdateInput,
        where: types.StatusHistoryWhereUniqueInput,
        include: Optional[types.StatusHistoryInclude] = None
    ) -> Optional[_PrismaModelT]:
        """Update a single StatusHistory record.

        Parameters
        ----------
        data
            StatusHistory record data specifying what to update
        where
            StatusHistory filter to select the unique record to create / update
        include
            Specifies which relations should be loaded on the returned StatusHistory model
        ...
        -------
        ```py
        statushistory = await StatusHistory.prisma().update(
            where={
                'id': 'bfiibjcehj',
            },
            data={
                # data to update the StatusHistory record to
            },
        )
        ```
        """
    ...
    async def upsert(
        self,
        where: types.StatusHistoryWhereUniqueInput,
        data: types.StatusHistoryUpsertInput,
        include: Optional[types.StatusHistoryInclude] = None,
    ) -> _PrismaModelT:
        """Updates an existing record or create a new one
        ...
        -------
        prisma.models.StatusHistory
            The created or updated StatusHistory record
        ...
        -------
        ```py
        statushistory = await StatusHistory.prisma().upsert(
            where={
                'id': 'ijieafghg',
            },
            data={
    ...
    async def update_many(
        self,
        data: types.StatusHistoryUpdateManyMutationInput,
        where: types.StatusHistoryWhereInput,
    ) -> int:
        """Update multiple StatusHistory records

        Parameters
        ----------
        data
            StatusHistory data to update the selected StatusHistory records to
        where
            Filter to select the StatusHistory records to update

        Returns
        -------
        int
            The total number of StatusHistory records that were updated
        ...
        -------
        ```py
        # update all StatusHistory records
        total = await StatusHistory.prisma().update_many(
            data={
                'technician_id': 'hhhegahcf'
            },
            where={}
        )
        ```
    ...
    async def count(
        ...
        """Count the number of StatusHistory records present in the database

        Parameters
        ----------
        select
            Select the StatusHistory fields to be counted
        take
            Limit the maximum result
        skip
            Ignore the first N records
        where
            StatusHistory filter to find records
        cursor
            Specifies the position in the list to start counting results from, (typically an ID field)
        order
            This parameter is deprecated and will be removed in a future release
        ...
        prisma.types.StatusHistoryCountAggregateOutput
            Data returned when `select` is used, the fields present in this dictionary will
            match the fields passed in the `select` argument
        ...
        ```py
        # total: int
        total = await StatusHistory.prisma().count()

        # results: prisma.types.StatusHistoryCountAggregateOutput
        results = await StatusHistory.prisma().count(
            select={
                '_all': True,
                'id': True,
            },
    ...
    async def count(
        self,
        select: types.StatusHistoryCountAggregateInput,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.StatusHistoryWhereInput] = None,
        cursor: Optional[types.StatusHistoryWhereUniqueInput] = None,
    ) -> types.StatusHistoryCountAggregateOutput:
        ...

    async def count(
        self,
        select: Optional[types.StatusHistoryCountAggregateInput] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.StatusHistoryWhereInput] = None,
        cursor: Optional[types.StatusHistoryWhereUniqueInput] = None,
    ) -> Union[int, types.StatusHistoryCountAggregateOutput]:
        """Count the number of StatusHistory records present in the database
        ...
        if select is None:
            ...
            return cast(types.StatusHistoryCountAggregateOutput, resp['data']['result']['_count'])

    async def delete_many(
        self,
        where: Optional[types.StatusHistoryWhereInput] = None
    ) -> int:
        """Delete multiple StatusHistory records.

        Parameters
        ----------
        where
            Optional StatusHistory filter to find the records to be deleted

        Returns
        -------
        int
            The total number of StatusHistory records that were deleted
        ...
        -------
        ```py
        # delete all StatusHistory records
        total = await StatusHistory.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            method='delete_many',
    ...
    async def group_by(
        self,
        by: List['types.StatusHistoryScalarFieldKeys'],
        *,
        where: Optional['types.StatusHistoryWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        avg: Optional['types.StatusHistoryAvgAggregateInput'] = None,
        sum: Optional['types.StatusHistorySumAggregateInput'] = None,
        min: Optional['types.StatusHistoryMinAggregateInput'] = None,
        max: Optional['types.StatusHistoryMaxAggregateInput'] = None,
        having: Optional['types.StatusHistoryScalarWhereWithAggregatesInput'] = None,
        count: Optional[Union[bool, 'types.StatusHistoryCountAggregateInput']] = None,
        order: Optional[Union[Mapping['types.StatusHistoryScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.StatusHistoryScalarFieldKeys', 'types.SortOrder']]]] = None,
    ) -> List['types.StatusHistoryGroupByOutput']:
        """Group StatusHistory records by one or more field values and perform aggregations
        each group such as finding the average.

        Parameters
        ----------
        by
            List of scalar StatusHistory fields to group records by
        where
            StatusHistory filter to select records
        take
            Limit the maximum number of StatusHistory records returned
        ...
        Returns
        -------
        List[prisma.types.StatusHistoryGroupByOutput]
            A list of dictionaries representing the StatusHistory record,
            this will also have additional fields present if aggregation arguments
            are used (see the above parameters)
        ...
        -------
        ```py
        # group StatusHistory records by status values
        # and count how many records are in each group
        results = await StatusHistory.prisma().group_by(
            ['status'],
            count=True,
        )
        ```
